...
func index(c *gin.Context){
    c.Data(http.StatusOK, "text/html", []byte("<html><body><img src=\"/data\"></img><div><p>Upload Feature Coming Soon&trade;</p></div><div><a href="github.com/liam-middlebrook/plug">Fork me on GitHub!</a></div></body></html>"))
}
